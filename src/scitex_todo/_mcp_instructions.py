...
budget-bound :mod:`scitex_todo._mcp_server`) and its own tests.
...
naming (see :data:`scitex_todo._users.IDENTITY_PREFIXES`, which exists to STRIP
...
existing :func:`scitex_todo._channel_identity.resolve_agent_id_optional`
