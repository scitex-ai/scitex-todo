...
def test_task_durations_full_task_computes_all_three_fields():
...
def test_task_durations_missing_created_at_leaves_two_fields_none():
    # Arrange
...
def test_task_durations_missing_started_at_leaves_two_fields_none():
    # Arrange
...
def test_task_durations_missing_completed_at_leaves_two_fields_none():
    # Arrange
...
def test_task_durations_handles_z_suffix_iso_strings():
...
def test_compute_timing_excludes_tasks_completed_outside_window():
...
def test_compute_timing_per_agent_only_lists_agents_with_done_tasks():
...
def test_compute_timing_per_group_rolls_null_group_into_ungrouped_key():
...
def test_compute_timing_per_group_rolls_empty_string_group_into_ungrouped():
...
def test_compute_timing_median_and_p95_on_small_distribution():
...
def test_compute_timing_per_project_aggregates_correctly():
...
def test_compute_timing_emits_window_envelope_fields():
...
def test_compute_timing_counts_done_tasks_with_missing_metadata():
...
def test_compute_timing_skips_task_with_no_agent_from_per_agent():
