...
def inbox_migrate_cmd(
    ...
    from scitex_todo._inbox import _load_inboxes_section
    from scitex_todo._inbox_sqlite import inbox_db_path, migrate_to_sqlite
...
def inbox_info_cmd(tasks_path: str | None, as_json: bool) -> None:
    ...
    from scitex_todo._inbox_sqlite import info as inbox_info
    from scitex_todo._paths import resolve_tasks_path
