...
```bash
ln -sf ~/.claude/skills/scitex/scitex-todo/hooks/pre-tool-use/redirect_claude_tasklist_to_scitex_todo.sh \
       ~/.claude/hooks/pre-tool-use/redirect_claude_tasklist_to_scitex_todo.sh
```
