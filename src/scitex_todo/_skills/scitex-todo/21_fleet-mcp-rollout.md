...
description: |
  ...
  `SCITEX_TODO_AGENT=<your-peer-name>` in the agent's env. Verify with
...
Every write tags the agent via env vars. **Set `SCITEX_TODO_AGENT`
...
SCITEX_TODO_AGENT=proj-<you> scitex-todo add \
...
# 4. Tear it down.
SCITEX_TODO_AGENT=proj-<you> scitex-todo done proj-<you>-mcp-smoke-<stamp>
```
