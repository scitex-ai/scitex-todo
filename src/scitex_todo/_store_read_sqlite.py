...
deadline is NEVER overdue") live in :func:`scitex_todo._model.is_overdue`, and
...
def list_tasks_sqlite(
    ...
    *,
    ...
    """The indexed equivalent of :func:`scitex_todo._store.list_tasks`.
    ...
    :func:`scitex_todo._model.is_overdue` the YAML path uses — see the module
