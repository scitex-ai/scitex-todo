...
* The :class:`~scitex_todo._delivery._ledger.Ledger` is the SOLE delivery
  truth — it decides what's already sent / retry-due.
* :func:`~scitex_todo._delivery._recipients.should_deliver_now` is the policy
...
def deliver_pending(
    ...
    *,
    ...
    channels : dict[str, DeliveryChannel] | None
        ...
        ``scitex_todo.delivery_channels`` entry-point group.
