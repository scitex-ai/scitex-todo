...
Standalone constraint: like the rest of :mod:`scitex_todo._users`, this
...
Distinction from :func:`scitex_todo._ports.canonical_agent_id`
--------------------------------------------------------------
    ...
    *,
    ...
    if strict:
        raise UnknownIdentityError(
            ...
            f"names[] alias via scitex_todo._users.register_user / add_alias) "
            f"or add an alias to scitex_todo._users.IDENTITY_ALIASES; see "
            f"scitex_todo._users._identity"
        )
    return key
