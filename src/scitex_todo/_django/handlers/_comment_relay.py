...
def _recipient_names(task: dict, author: str) -> list[str]:
...
def comment_inbox_toast(task: dict, author: str) -> dict:
    ...
    try:
        queued = _recipient_names(task, author)
