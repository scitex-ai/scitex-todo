#!/usr/bin/env bash
# Outer apptainer-exec wrapper for scitex-todo's self-hosted (Spartan) CI.
#
...
#   bash .github/ci/exec-in-sif.sh import-smoke.sh 3.12
#   bash .github/ci/exec-in-sif.sh audit.sh
#
