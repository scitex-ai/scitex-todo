...
Extracted from :mod:`scitex_todo._cli._board` to keep that module under
...
# is launched via Django's ``call_command("scitex_todo_board", ...)``
...
_BOARD_CMDLINE_MARKERS = ("scitex_todo_board", "scitex_todo._django")
