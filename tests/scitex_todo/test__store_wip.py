#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""End-to-end tests for ``scitex_todo._store_wip`` — the WIP gate's add-path
...
from scitex_todo._store_wip import (
    EXEMPT_PRIORITY_MAX,
    OVERRIDE_COMMENT_KIND,
    is_priority_exempt,
)
from scitex_todo._throughput import ENV_WIP_LIMIT
