...
push wire (:func:`scitex_todo._push.deliver`) — operator's standing
direction that "agents see their own numbers every hour and
self-correct."

The rollup uses the aggregator in :mod:`scitex_todo._throughput` so the
...
in :mod:`scitex_todo._cli._sync_github`; :func:`register` wires both.
"""
