...
Usage (standalone):
    scitex-todo board
    # or, directly:
    python -m scitex_todo._django.management.commands.scitex_todo_board
...
Usage (integrated into a Django project):
    ...
    # urls.py
    path("scitex-todo/", include("scitex_todo._django.urls")),
"""

default_app_config = "scitex_todo._django.apps.ScitexTodoConfig"
