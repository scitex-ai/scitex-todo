...
from . import _listen as _listen_cli
...
# `listen` — scitex-todo's own persistent HTTP listen server (the mirror of
# `sac listen`). Wired here for the same reason.
_listen_cli.register(main)
